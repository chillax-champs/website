...
var ue_id = 'YMEZR25SNWFYE04C6ZDP',
    ue_url = '/ap/uedata',
    ue_navtiming = 1,
    ue_mid = 'A21TJRUUN4KGV',
    ue_sid = '262-5733930-4616502',
    ue_sn = 'www.amazon.in',
    ...
    ue_rpl_ns = 'cel-rpl',
    ue_ddq = 1,
    ue_fpf = '//fls-eu.amazon.com/1/batch/1/OP/A21TJRUUN4KGV:262-5733930-4616502:YMEZR25SNWFYE04C6ZDP$uedata=s:',
    ue_sbuimp = 1,
    ue_ibft = 0,
    ue_sswmts = 0,
    ue_jsmtf = 0,
...
if (window.csa) {
    csa("Config", {
        ...
        'CacheDetection.RequestID': "YMEZR25SNWFYE04C6ZDP",
    ...
    csa("Events")("setEntity", {
        page: {requestId: "YMEZR25SNWFYE04C6ZDP", meaningful: "interactive"},
        session: {id: "262-5733930-4616502"}
    });
}
...
<span class="a-dropdown-container"><select name="countryCode" autocomplete="off" data-a-touch-header="Country/Region Code" id="auth-country-picker" tabindex="0" data-action="a-dropdown-select" class="a-native-dropdown a-declarative">
    ...
    <option data-calling-code="853" data-country-code="MO" value="MO" data-a-html-content="Macau &lt;span dir='ltr'&gt;+853&lt;/span&gt;">
    ...
    <option data-calling-code="389" data-country-code="MK" value="MK" data-a-html-content="Macedonia &lt;span dir='ltr'&gt;+389&lt;/span&gt;">
    ...
    <option data-calling-code="268" data-country-code="SZ" value="SZ" data-a-html-content="Swaziland &lt;span dir='ltr'&gt;+268&lt;/span&gt;">
    ...
    <option data-calling-code="90" data-country-code="TR" value="TR" data-a-html-content="Turkey &lt;span dir='ltr'&gt;+90&lt;/span&gt;">
    ...
    <option data-calling-code="1" data-country-code="US" value="US" data-a-html-content="United States &lt;span dir='ltr'&gt;+1&lt;/span&gt;">
    ...
    <option data-calling-code="358" data-country-code="AX" value="AX" data-a-html-content="Åland Islands &lt;span dir='ltr'&gt;+358&lt;/span&gt;">
...
</select><span tabindex="-1" id="auth-country-picker-container" class="a-button a-button-dropdown" aria-hidden="true"><span class="a-button-inner"><span class="a-button-text a-declarative" data-csa-c-func-deps="aui-da-a-dropdown-button" data-csa-c-type="widget" data-csa-interaction-events="click" data-action="a-dropdown-button" aria-hidden="true"><span class="a-dropdown-prompt">IN +91</span></span><i class="a-icon a-icon-dropdown"></i></span></span></span>
      ...
      <div class="a-fixed-left-grid-col a-col-right" style="padding-left:2%;float:left;">
        <input type="tel" maxlength="50" id="ap_phone_number" autocomplete="tel" placeholder="Mobile number" name="email" tabindex="3" class="a-input-text a-span12 a-spacing-micro auth-required-field auth-require-phone-validation" data-validation-id="phoneNumber" aria-required="true"/>
...
<div id="auth-inline-phoneNumber-success-checklist" class="a-section auth-inline-success-checklist">
    
    
        <div id="auth-phoneNumber-success-check-item-2" class="a-box a-alert-inline a-alert-inline-success auth-inline-grey-check-item a-spacing-top-mini" aria-live="polite" aria-atomic="true"><div class="a-box-inner a-alert-container"><i class="a-icon a-icon-alert"></i><div class="a-alert-content">
...
<div class="a-row a-spacing-base">
  ...
  <input type="password" maxlength="1024" id="ap_password" autocomplete="new-password" placeholder="At least 6 characters" name="password" tabindex="5" class="a-input-text a-span12 auth-required-field auth-require-fields-match auth-require-password-validation" aria-required="true"/>
...
<div id="auth-inline-password-success-checklist" class="a-section auth-inline-success-checklist">
        ...
        <div id="auth-password-success-check-item-2" class="a-box a-alert-inline a-alert-inline-success auth-inline-grey-check-item a-spacing-top-mini" aria-live="polite" aria-atomic="true"><div class="a-box-inner a-alert-container"><i class="a-icon a-icon-alert"></i><div class="a-alert-content">
            Enter at least 6 characters
        </div></div></div>
      ...
      <div id="mobileClaimDisclosureMessage" class="a-section a-spacing-top-mini aok-hidden">
      ...
      <div id="mobileClaimDisclosureMessageRelaxed" class="a-section a-spacing-top-mini aok-hidden">
      ...
      <div class="a-section a-spacing-extra-large ap_mobile_number_fields">
        <span id="auth-continue" class="a-button a-button-span12 a-button-primary auth-requires-verify-modal"><span class="a-button-inner"><input id="continue" tabindex="9" class="a-button-input" type="submit" aria-labelledby="auth-continue-announce"/><span id="auth-continue-announce" class="a-button-text" aria-hidden="true">
...
<div class="a-row">
    ...
    <div class="a-section a-spacing-base">
        <a id="ab-enhanced-registration-link" class="a-link-normal" href="https://www.amazon.in/business/register/org/landing?ref_=ap_altreg_ab">
        ...
        <div class="a-row">
          ...
          <a class="a-link-emphasis" href="/ap/signin?openid.pape.max_auth_age=0&amp;openid.return_to=https%3A%2F%2Fwww.amazon.in%2Fs%3Fk%3Dlogin%2Bamazon%2Baccount%26adgrpid%3D59671903835%26ext_vrnc%3Dhi%26hvadid%3D590652406969%26hvdev%3Dc%26hvlocphy%3D1007769%26hvnetw%3Dg%26hvqmt%3De%26hvrand%3D5076468050355587756%26hvtargid%3Dkwd-837441119212%26hydadcr%3D24542_2265395%26tag%3Dgooginhydr1-21%26ref%3Dnav_custrec_signin&amp;prevRID=YMEZR25SNWFYE04C6ZDP&amp;openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.assoc_handle=inflex&amp;openid.mode=checkid_setup&amp;failedSignInCount=0&amp;openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;pageId=inflex&amp;openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0">
            Sign in
          </a>
        </div>
...
<noscript>
    <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-eu.amazon.com/1/batch/1/OP/A21TJRUUN4KGV:262-5733930-4616502:YMEZR25SNWFYE04C6ZDP$uedata=s:%2Fap%2Fuedata%3Fnoscript%26id%3DYMEZR25SNWFYE04C6ZDP:0' alt=""/>
</noscript>

<script>window.ue && ue.count && ue.count('CSMLibrarySize', 48896)</script></body>
</html>
